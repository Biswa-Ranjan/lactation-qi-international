...
*/
  ...
  static messages: IMessage = {
    ...
    volumeOfMilkExpressedFromBreast:'Please enter valid volume for EBM (in ml)',
    ...
    ommVolumne: 'Please enter valid omm volume (in ml, range 0-300)',
    dhmVolume: 'Please enter valid dhm volume (in ml, range 0-300)',
    formulaVolume: 'Please enter valid formula volume (in ml, range 0-300)',
    animalMilkVolume: 'Please enter valid animal milk voulme (in ml, range 0-300)',
    otherVolume: 'Please enter valid other voulme (in ml, range 0-300)',
